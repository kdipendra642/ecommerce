    ...
    <div class="row">
        <div class="col-lg-12">
            <section class="panel">
                ...
                <div class="panel-body">
                    <form class="form-horizontal tasi-form" action="{{ route('blogs.update', $blogs->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        <select class="form-control m-bot15" name="blog_category_id">
                                            ...
                                            <option value="{{ $cate->id }}" {{ ($cate->id == $blogs->blog_category_id) ? 'selected' : ''}}>{{ $cate->blog_category_name_en }} | {{ $cate->blog_category_name_nep }}</option>
                                            @endforeach
                                        </select>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="post_title_en" class="form-control" value="{{ $blogs->post_title_en}}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="post_title_nep" class="form-control" value="{{ $blogs->post_title_nep}}">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="file" name="post_image" class="form-control" onChange="sliderImage(this)" data-validation-required-message="This field is required">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <img src="{{ asset(''.$blogs->post_image) }}" alt="" id="mainCoverImage" style="width:90px; height: 90px;">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea name="post_description_en" id="post_description_en" cols="30" rows="10">{!! $blogs->post_description_en !!}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea name="post_description_hin" id="post_description_hin" cols="30" rows="10">{!! $blogs->post_description_hin !!}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
