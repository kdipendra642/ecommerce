    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form role="form" action="{{ route('state.edit', $item->id)}}" method="POST">
                    @csrf
                    <div class="form-group">
                        <label for="exampleInputEmail1">Shipping State</label>
                        <input type="text" class="form-control" id="exampleInputEmail3" name="state_name" value="{{$item->state_name}}" placeholder="Enter shipping state">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control m-bot15" name="district_id">
                            ...
                            <option value="{{$district->id}}" @if($district->id == $item->district_id) selected @endif>{{$district->district_name}}</option>
                            @endforeach
                        </select>
                    </div>
