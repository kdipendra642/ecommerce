                ...
                <div class="panel-body">
                    <div class="adv-table">
                        <table class="display table table-bordered table-striped dataTable" id="dynamic-table" aria-describedby="dynamic-table_info">
                            ...
                            <tbody>
                                @foreach($delivered_order as $item)
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn btn-group">
                                            ...
                                            <!-- <a href="#" class="btn btn-danger btn-xs btn-round" title="Delete this coupon" id="delete" style="margin-left: 5px;"><i class="fa fa-trash-o"></i> Delete</a> -->
                                        </div>
                                    </td>
                                </tr>
                                @endforeach
