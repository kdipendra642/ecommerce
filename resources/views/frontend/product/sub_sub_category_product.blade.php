    ...
    <div class="container">
        <div class="breadcrumb-inner">
            <ul class="list-inline list-unstyled">
                <li><a href="#">Home</a></li>
                @foreach($breadsubcat as $breadcum)
                <li class='active'>{{$breadcum->category->category_name_en}}</li>
                <li class='active'>{{$breadcum->subcategory->sub_category_en}}</li>
                <li class='active'>{{$breadcum->sub_sub_category_en}}</li>
                @endforeach
            </ul>
        </div>
        <!-- /.breadcrumb-inner -->
                                        ...
                                        <div class="accordion-body collapse" id="collapseOne{{$category->id}}" style="height: 0px;">
                                            <div class="accordion-inner">
                                                ...
                                                <ul>
                                                    ...
                                                    @if(session()->get('language') == 'nepali')
                                                    <li><a href="{{ route('subcategory.product',[ 'id' => $subcategory -> id, 'slug' => $subcategory->sub_category_en_slug]) }}">{{$subcategory->sub_category_hin}}</a></li>
                                                    @else
                                                    <li><a href="{{ route('subcategory.product',[ 'id' => $subcategory -> id, 'slug' => $subcategory->sub_category_en_slug]) }}">{{$subcategory->sub_category_en}}</a></li>
                                                    @endif
                                                    @endforeach
                                                </ul>
                                            </div>
                                                ...
                                                <div class="col col-sm-8 col-lg-8">
                                                    <div class="product-info">
                                                        ...
                                                        <div class="description m-t-10">
                                                            @if(session()->get('language') == 'nepali')
                                                            {{ Str::limit($product->short_description_hin, 200) }}
                                                            @else
                                                            {{ Str::limit($product->short_description_en, 200) }}
                                                            @endif
                                                        </div>
                                                        <div class="cart clearfix animate-effect">
                                                            <div class="action">
