            ...
            <div class="header-top-inner">
                <div class="cnt-account">
                    <ul class="list-unstyled">
                        ...
                        @auth
                        <li>
                            <a href="#" data-toggle="modal" data-target="#orderTracking"><i class="icon fa fa-check"></i>
                                Order Tracking
                            </a>
                        </li>
                        @endauth
                    ...
                    <div class="search-area">
                        <form method="POST" action="{{ route('product.search') }}">
                            ...
                            <div class="control-group">
                                ...
                                <!-- goto public/frontend/assets/js/script.js for advance search jquery code. -->
                                <input class="search-field" placeholder="Search here..." name="search_term" id="search_term" autocomplete="off" onfocus="search_result_show()" onblur="search_result_hide()" />
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                ...
                                <div class="clearfix cart-total">
                                    ...
                                    <div class="clearfix"></div>
                                    <a href="{{ route('mycart')}}" class="btn btn-upper btn-primary btn-block m-t-20">Checkout</a>
                                </div>
                                <!-- /.cart-total-->
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-danger" id="exampleModalLabel">Copy and paste your invoice number here.</h5>
                ...
                <div class="modal-body">
                    <form action="{{ route('order.tracking') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="invoice_number" required="" class="form-control" placeholder="Your order invoice number here.">
                        </div>
