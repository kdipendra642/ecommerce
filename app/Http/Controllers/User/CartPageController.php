...
class CartPageController extends Controller
{
    ...
    public function IncrementCartProduct($rowId)
    {
        ...
        if (Session::has('coupon')) {
            ...
            Session::put('coupon', [
                ...
                'total_amount' => round(Cart::total() *  $coupon->coupon_discount / 100),
            ]);
        }
        return response()->json(['incremented' => 'Product increased from cart.']);
    }
    ...
    public function DecrementCartProduct($rowId)
    {
        ...
        return response()->json(['incremented' => 'Product decreased from cart.']);
    }
}
